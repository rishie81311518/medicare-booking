...
<div>
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero officiis mollitia vitae nisi quia error cum dolorem officia temporibus voluptatibus, consequuntur, quaerat rem facilis molestiae sunt quos iste, quam eligendi?</p>
...
<section>
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
        ...
        <p className='text-[16px] leading-7 textColor font-[400] mt-4 text-center'>
        World-class care for everyone. Our health System offers unmatched,
                expert health care.
        </p>
